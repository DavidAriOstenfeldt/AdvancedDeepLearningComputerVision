...
unet_ddpm_cFg.load_state_dict(torch.load('4_DiffusionClassifier/weights/DDPM-cfg/model.pth', map_location=device))
...
show(imgs, fig_titles=CLASS_LABELS, title='classifier FREE guidance', save_path='assets/cFg_samples.pdf')
